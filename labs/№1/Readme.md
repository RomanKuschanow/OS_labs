...
2. Після перегляду відео дайте відповіді на наступні питання.
    ...
    1. Вибір мову користувацького інтерфейсу.
    2. Вибір клавіатурної мови.
    3. Завантаження мережевих профілів.
    4. Встановлення системи.
    5. Підтвердження налаштувань і дискових партій.
    6. Введення користувача, його пароля та інших деталей доступу.
    7. Встановлення додаткових пакунків за бажанням.
